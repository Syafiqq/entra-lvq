 ...
 * @author Entra
 */
public class PengujianDatasetFrame extends ClosableInternalFrame
{
    ...
    /**
     * Creates new form PengujianDatasetFrame
     */
    public PengujianDatasetFrame(InteractionListener listener)
    {
        ...
        this.addInternalFrameListener(new COpenClosableInternalFrameListener()
        {
            ...
            {
                PengujianDatasetFrame.this.testingLog.addObserver(PengujianDatasetFrame.this.logObserver);
                PengujianDatasetFrame.this.lvq.weightUpdateListeners.add(PengujianDatasetFrame.this.weightObserver);
                PengujianDatasetFrame.this.lvq.distanceCalculationListener.add(PengujianDatasetFrame.this.datasetObserver);
                PengujianDatasetFrame.this.lvq.accuracyListeners.add(PengujianDatasetFrame.this.accuracyObserver);
                PengujianDatasetFrame.this.lvq.testAccuracyListeners.add(PengujianDatasetFrame.this.accuracyObserver);
                PengujianDatasetFrame.this.lvq.trainingListeners.add(PengujianDatasetFrame.this.trainObserver);

                PengujianDatasetFrame.this.lvq.testingListeners.add(PengujianDatasetFrame.this.testingObserver);
                PengujianDatasetFrame.this.lvq.testWeightUpdateListeners.add(PengujianDatasetFrame.this.testWeightObserver);

                PengujianDatasetFrame.this.lvq.postInitializeListener.add(PengujianDatasetFrame.this.lPostInitializationObserver);
                PengujianDatasetFrame.this.lvq.postSatisfactionListeners.add(PengujianDatasetFrame.this.lPostSatisfactionObserver);
                PengujianDatasetFrame.this.lvq.distanceCalculationListener.add(PengujianDatasetFrame.this.lDistanceCalculationObserver);
                PengujianDatasetFrame.this.lvq.weightUpdateListeners.add(PengujianDatasetFrame.this.lWeightUpdateObserver);
                PengujianDatasetFrame.this.lvq.reducedLearningRateListener.add(PengujianDatasetFrame.this.lReducedLearningRateObserver);
                PengujianDatasetFrame.this.lvq.accuracyListeners.add(PengujianDatasetFrame.this.lAccuracyObserver);
                PengujianDatasetFrame.this.lvq.satisfactionEvaluationListeners.add(PengujianDatasetFrame.this.lSatisfactionEvaluationObserver);

                PengujianDatasetFrame.this.lvq.testDistanceCalculationListener.add(PengujianDatasetFrame.this.lTestDistanceCalculationObserver);
                PengujianDatasetFrame.this.lvq.testWeightUpdateListeners.add(PengujianDatasetFrame.this.lTestWeightUpdateObserver);
                PengujianDatasetFrame.this.lvq.testAccuracyListeners.add(PengujianDatasetFrame.this.lTestAccuracyObserver);
            }

            @Override public void internalFrameClosed(InternalFrameEvent e)
            {
                PengujianDatasetFrame.this.testingLog.deleteObserver(PengujianDatasetFrame.this.logObserver);
                PengujianDatasetFrame.this.lvq.weightUpdateListeners.remove(PengujianDatasetFrame.this.weightObserver);
                PengujianDatasetFrame.this.lvq.distanceCalculationListener.remove(PengujianDatasetFrame.this.datasetObserver);
                PengujianDatasetFrame.this.lvq.accuracyListeners.remove(PengujianDatasetFrame.this.accuracyObserver);
                PengujianDatasetFrame.this.lvq.testAccuracyListeners.remove(PengujianDatasetFrame.this.accuracyObserver);
                PengujianDatasetFrame.this.lvq.trainingListeners.remove(PengujianDatasetFrame.this.trainObserver);

                PengujianDatasetFrame.this.lvq.testingListeners.remove(PengujianDatasetFrame.this.testingObserver);
                PengujianDatasetFrame.this.lvq.testWeightUpdateListeners.add(PengujianDatasetFrame.this.testWeightObserver);

                PengujianDatasetFrame.this.lvq.postInitializeListener.remove(PengujianDatasetFrame.this.lPostInitializationObserver);
                PengujianDatasetFrame.this.lvq.postSatisfactionListeners.remove(PengujianDatasetFrame.this.lPostSatisfactionObserver);
                PengujianDatasetFrame.this.lvq.distanceCalculationListener.remove(PengujianDatasetFrame.this.lDistanceCalculationObserver);
                PengujianDatasetFrame.this.lvq.weightUpdateListeners.remove(PengujianDatasetFrame.this.lWeightUpdateObserver);
                PengujianDatasetFrame.this.lvq.reducedLearningRateListener.remove(PengujianDatasetFrame.this.lReducedLearningRateObserver);
                PengujianDatasetFrame.this.lvq.accuracyListeners.remove(PengujianDatasetFrame.this.lAccuracyObserver);
                PengujianDatasetFrame.this.lvq.satisfactionEvaluationListeners.remove(PengujianDatasetFrame.this.lSatisfactionEvaluationObserver);

                PengujianDatasetFrame.this.lvq.testDistanceCalculationListener.remove(PengujianDatasetFrame.this.lTestDistanceCalculationObserver);
                PengujianDatasetFrame.this.lvq.testWeightUpdateListeners.remove(PengujianDatasetFrame.this.lTestWeightUpdateObserver);
                PengujianDatasetFrame.this.lvq.testAccuracyListeners.remove(PengujianDatasetFrame.this.lTestAccuracyObserver);
            }
        });
    }
    ...
    private void initializeDataObserver()
    {
        ...
        this.weightObserver = new DebuggableLVQ1.OnWeightUpdateListener()
        {
            ...
            {
                final DefaultTableModel weightTable = (DefaultTableModel) PengujianDatasetFrame.this.tbweight.getModel();
        ...
        this.datasetObserver = new DebuggableLVQ1.OnDistanceCalculationListener()
        {
            ...
            {
                final DefaultTableModel datasetTable = (DefaultTableModel) PengujianDatasetFrame.this.tbtraining.getModel();
        ...
        this.testWeightObserver = new DebuggableLVQ1.OnWeightUpdateListener()
        {
            ...
            {
                final DefaultTableModel datasetTable = (DefaultTableModel) PengujianDatasetFrame.this.tbtraining.getModel();
                int index = PengujianDatasetFrame.this.lvq.getTesting().indexOf(data);
                int i = 0;
                int c = 22;
                datasetTable.setValueAt(data.actualTarget, index, ++c);
                ++i;
    ...
    private void initComponents()
    {
        ...
        setClosable(true);
        setMaximizable(true);
        setTitle("Proses Pengujian untuk Membandingkan Data Latih dan Data Uji");
        setToolTipText("");
                                                    ...
                                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                           .addGroup(jPanel1Layout.createSequentialGroup()
                                                                                                  ...
                                                                                                  .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                                                                                         ...
                                                                                                                         .addComponent(training, javax.swing.GroupLayout.Alignment.LEADING, 0, 69, Short.MAX_VALUE)
                                                                                                                         .addComponent(epoch)
