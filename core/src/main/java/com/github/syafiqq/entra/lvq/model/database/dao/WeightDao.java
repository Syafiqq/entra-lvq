...
public class WeightDao
{
    ...
    public static WeightPojo insert(@NotNull DatabaseApp db, @NotNull WeightPojo pojo)
    {
        pojo.id = WeightDao._insert(db, pojo);
        return pojo;
    }

    private static int _insert(@NotNull DatabaseApp db, @NotNull WeightPojo pojo)
    {
        db.setProperties(db);
        int id = 0;
        try
